...
public class FinalJewelryTests {
    ...
    // ============================ TC1 ============================
    @Test(priority = 1)
    public void TC1_AddToCompareFromJewelry() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Jewelry")));
            moveAndClick(nav);
            humanDelay();
            ...
            System.out.println("TC1 Passed: Jewelry added to compare.");
    ...
    // ============================ TC2 ============================
    @Test(priority = 2)
    public void TC2_AddToCartFromJewelry() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Jewelry")));
            moveAndClick(nav);
            humanDelay();
            ...
            System.out.println("TC2 Passed: Jewelry added to cart.");
    ...
    // ============================ TC3 ============================
    @Test(priority = 3)
    public void TC3_ProductDetailsPage_Jewelry() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Jewelry")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC6 ============================
    @Test(priority = 6)
    public void TC6_ItemsPerPage3_Jewelry() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Jewelry")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC7 ============================
    @Test(priority = 7)
    public void TC7_ChangeLayoutToVertical_Jewelry() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Jewelry")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC8 ============================
    @Test(priority = 8)
    public void TC8_FilterPriceRange_Jewelry() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Jewelry")));
            moveAndClick(nav);
            humanDelay();
