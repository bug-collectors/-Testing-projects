...
public class FinalBooksTests {
    ...
    // ============================ TC1 ============================
    @Test(priority = 1)
    public void TC1_AddToCompareFromBooks() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Books")));
            moveAndClick(nav);
            humanDelay();
            ...
            System.out.println("TC1 Passed: Book added to compare.");
    ...
    // ============================ TC2 ============================
    @Test(priority = 2)
    public void TC2_AddToCartFromBooks() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Books")));
            moveAndClick(nav);
            humanDelay();
            ...
            System.out.println("TC2 Passed: Book added to cart.");
    ...
    // ============================ TC3 ============================
    @Test(priority = 3)
    public void TC3_ProductDetailsPage_Books() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Books")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC6 ============================
    @Test(priority = 6)
    public void TC6_ItemsPerPage3_Books() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Books")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC7 ============================
    @Test(priority = 7)
    public void TC7_ChangeLayoutToVertical_Books() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Books")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC8 ============================
    @Test(priority = 8)
    public void TC8_FilterPriceRange_Books() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Books")));
            moveAndClick(nav);
            humanDelay();
