...
public class FinalGiftCardsTests {
    ...
    // ============================ TC1 ============================
    @Test(priority = 1)
    public void TC1_AddToCompareFromGiftCards() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Gift Cards")));
            moveAndClick(nav);
            humanDelay();
            ...
            if (!compareCounters.isEmpty()) {
                int count = Integer.parseInt(compareCounters.get(0).getText().replaceAll("[^0-9]", ""));
                Assert.assertTrue(count >= 1, "TC1 Failed: Compare count not incremented.");
            }

            System.out.println("TC1 Passed: Gift card added to compare.");
    ...
    // ============================ TC2 ============================
    @Test(priority = 2)
    public void TC2_AddToCartFromGiftCards() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Gift Cards")));
            moveAndClick(nav);
            humanDelay();
            ...
            if (!cartCounters.isEmpty()) {
                int qty = Integer.parseInt(cartCounters.get(0).getText().replaceAll("[^0-9]", ""));
                Assert.assertTrue(qty >= 1, "TC2 Failed: Cart quantity not updated.");
            }

            System.out.println("TC2 Passed: Gift card added to cart.");
    ...
    // ============================ TC3 ============================
    @Test(priority = 3)
    public void TC3_ProductDetailsPage_GiftCards() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Gift Cards")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC6 ============================
    @Test(priority = 6)
    public void TC6_ItemsPerPage3_GiftCards() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Gift Cards")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC7 ============================
    @Test(priority = 7)
    public void TC7_ChangeLayoutToVertical_GiftCards() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Gift Cards")));
            moveAndClick(nav);
            humanDelay();
    ...
    // ============================ TC8 ============================
    @Test(priority = 8)
    public void TC8_FilterPriceRange_GiftCards() {
        try {
            WebElement nav = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Gift Cards")));
            moveAndClick(nav);
            humanDelay();
